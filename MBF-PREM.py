...
\x1b[1;97m		█▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄█
\x1b[1;94m✠═╦════════════════════════════════════════════════════✠
\x1b[1;94m  ║ \x1b[1;97m[1] \x1b[1;93mNC : Sanz X Danz╰_╯ \x1b[1;94m║ \x1b[1;97m[4] \x1b[1;93mXNXCODE TEAM ╰_╯
\x1b[1;94m  ║ \x1b[1;97m[2] \x1b[1;93mFB : Sanz X Danz    \x1b[1;94m║ \x1b[1;97m[5] \x1b[1;93mYAYAN XD╰_╯
...
#        sys.stdout.write('\r %s[%s+%s] %s[Cracking] %s/%s /\_/-> OK-:%s /\_/-> CP-:%s '%(B,P,B,P,loop,len(self.id),len(ok),len(cp))),
        ...
        for pw in _____jeeck_____:
            ...
            try:
            	...
            	_ganiganiganihujanbadaianginribut = 'Mozilla/5.0 (Linux; Android 10; Mi 9T Pro Build/QKQ1.190825.002; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/88.0.4324.181 Mobile Safari/537.36[FBAN/EMA;FBLC/it_IT;FBAV/239.0.0.10.109;]'
